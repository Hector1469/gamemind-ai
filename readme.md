...
El objetivo es proporcionar recomendaciones más precisas, explicables y robustas que las típicas sugerencias automáticas de plataformas de juegos. 
...
4. Genera una respuesta final coherente 

 

Herramientas del agente 

El sistema dispone de 3 tools principales: 

1. search_game_tool: Consulta la API oficial de Steam y devuelve 
...
2. recommend_games_tool: Consulta el api SteamSpy  y recomienda juegos basados en tags de género aplicando un sistema de ranking: 
...
Devuelve información estructurada del juego  
...
search_game_tool → obtiene tags del juego 

recommend_games_tool → genera recomendaciones 

Si falla -> game_profile_rag_tool (fallback semántico) 
...
Si también falla el agente informa al usuario sin inventar resultados 
...
git clone https://github.com/tuusuario/gamemind-ai.git 
